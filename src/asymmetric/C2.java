...
public class C2
{
   public static void main(String[] args) throws Exception
   {
      ...
      BigInteger c = new BigInteger("");
      ...
      /*--USING MANUAL CALUCLATION TO FIND RSA*/
      BigInteger ptMan = c.modPow(d, n);
      System.out.println("PT from JCE:\t"+ new String (ptMan.toByteArray()));
   }
}