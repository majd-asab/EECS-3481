...
public class B1 {
		...
		public static int  repeat(String pt1,byte[] ct1, byte[] key)throws Exception{
			...
			//System.out.println("RplcNumber:  "+ changed);// flipped binary string
...
//			System.out.println(new String(flipped)); //outputs the string of a binary-string pattern with a flipped bit
			// encrypt the flipped string
			System.out.println(flippedStr.length());
